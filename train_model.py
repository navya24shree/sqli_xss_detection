...
def build_model(vocab_size, maxlen, embedding_dim, num_classes):
    ...
    # BETTER REGULARIZATION FOR TEXT
    x = layers.SpatialDropout1D(0.3)(x)

    # MULTI-SCALE CNN FOR BETTER PATTERN CAPTURE
    conv3 = layers.Conv1D(256, kernel_size=3, padding="same", activation="relu")(x)
    conv5 = layers.Conv1D(256, kernel_size=5, padding="same", activation="relu")(x)
    conv7 = layers.Conv1D(256, kernel_size=7, padding="same", activation="relu")(x)
